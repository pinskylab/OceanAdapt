...
# 4. all_objects.Rdata - this will load all of the objects generated by this script so that the only need to run this script is if you want to change the output or troubleshoot.
...
# 5. #OPTIONAL, DEFAULT:FALSE, generate dat.exploded table/file.  Warning, this can cause some laptops to crash because of the size.
DAT_EXPLODED <- TRUE
